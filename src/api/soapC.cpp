...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.78 2019-02-09 12:49:32 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_ns1__SubmitScreenShot:
		return soap_in_ns1__SubmitScreenShot(soap, tag, NULL, "ns1:SubmitScreenShot");
	case SOAP_TYPE_ns1__SubmitScreenShotResponse:
		return soap_in_ns1__SubmitScreenShotResponse(soap, tag, NULL, "ns1:SubmitScreenShotResponse");
	case SOAP_TYPE_ns1__NotifyStatus:
		return soap_in_ns1__NotifyStatus(soap, tag, NULL, "ns1:NotifyStatus");
	case SOAP_TYPE_ns1__NotifyStatusResponse:
		return soap_in_ns1__NotifyStatusResponse(soap, tag, NULL, "ns1:NotifyStatusResponse");
	case SOAP_TYPE_ns1__GetResource:
		return soap_in_ns1__GetResource(soap, tag, NULL, "ns1:GetResource");
	case SOAP_TYPE_ns1__GetResourceResponse:
		return soap_in_ns1__GetResourceResponse(soap, tag, NULL, "ns1:GetResourceResponse");
	case SOAP_TYPE_ns1__MediaInventory:
		return soap_in_ns1__MediaInventory(soap, tag, NULL, "ns1:MediaInventory");
	case SOAP_TYPE_ns1__MediaInventoryResponse:
		return soap_in_ns1__MediaInventoryResponse(soap, tag, NULL, "ns1:MediaInventoryResponse");
	case SOAP_TYPE_ns1__SubmitStats:
		return soap_in_ns1__SubmitStats(soap, tag, NULL, "ns1:SubmitStats");
	case SOAP_TYPE_ns1__SubmitStatsResponse:
		return soap_in_ns1__SubmitStatsResponse(soap, tag, NULL, "ns1:SubmitStatsResponse");
	case SOAP_TYPE_ns1__SubmitLog:
		return soap_in_ns1__SubmitLog(soap, tag, NULL, "ns1:SubmitLog");
	case SOAP_TYPE_ns1__SubmitLogResponse:
		return soap_in_ns1__SubmitLogResponse(soap, tag, NULL, "ns1:SubmitLogResponse");
	case SOAP_TYPE_ns1__BlackList:
		return soap_in_ns1__BlackList(soap, tag, NULL, "ns1:BlackList");
	case SOAP_TYPE_ns1__BlackListResponse:
		return soap_in_ns1__BlackListResponse(soap, tag, NULL, "ns1:BlackListResponse");
	case SOAP_TYPE_ns1__Schedule:
		return soap_in_ns1__Schedule(soap, tag, NULL, "ns1:Schedule");
	case SOAP_TYPE_ns1__ScheduleResponse:
		return soap_in_ns1__ScheduleResponse(soap, tag, NULL, "ns1:ScheduleResponse");
	case SOAP_TYPE_ns1__GetFile:
		return soap_in_ns1__GetFile(soap, tag, NULL, "ns1:GetFile");
	case SOAP_TYPE_ns1__GetFileResponse:
		return soap_in_ns1__GetFileResponse(soap, tag, NULL, "ns1:GetFileResponse");
	case SOAP_TYPE_ns1__RequiredFiles:
		return soap_in_ns1__RequiredFiles(soap, tag, NULL, "ns1:RequiredFiles");
	case SOAP_TYPE_ns1__RequiredFilesResponse:
		return soap_in_ns1__RequiredFilesResponse(soap, tag, NULL, "ns1:RequiredFilesResponse");
	case SOAP_TYPE_ns1__RegisterDisplay:
		return soap_in_ns1__RegisterDisplay(soap, tag, NULL, "ns1:RegisterDisplay");
	case SOAP_TYPE_ns1__RegisterDisplayResponse:
		return soap_in_ns1__RegisterDisplayResponse(soap, tag, NULL, "ns1:RegisterDisplayResponse");
